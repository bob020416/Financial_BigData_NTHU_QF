...
```{r}
# select the 3rd, 6th, 9th, etc. variables from the flights dataset

selected_columns <- flights %>% select(seq(3, ncol(flights), by = 3))

selected_columns %>% ptable()
```
